...
const Keyboard = {
  ...
  init() {
    ...
    this.elements.main.appendChild(this.createKeyboard(this.properties.language));
            ...
            if (event.keyCode === key.keyCode) {
              ...
              if (event.shiftKey || this.properties.shiftKeyPressed) {
                if (this.properties.capsLock) {
                  ...
                  this.properties.value += key[`${this.properties.language}Modified`].toUpperCase();
                }
              } else {
    ...
    if (event.shiftKey && event.ctrlKey) {
      ...
      for (const key of this.elements.keys) {
        ...
        if (specKeys) {
          if (event.shiftKey) {
            if (this.properties.capsLock) {
              key.textContent = keyLayout[i][`${language}Modified`].toLowerCase();
            } else {
              key.textContent = keyLayout[i][`${language}Modified`].toUpperCase();
            }
          } else {
